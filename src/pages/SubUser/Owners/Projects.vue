<template>
  <div class="d-flex flex-column flex-grow-1">
    <div class="d-flex align-center py-3">
      <div>
        <div class="display-1">Owner Projects</div>
...
<script>
import ProjectsList from '@/components/owner/ProjectList'
...
export default {
  ...
  async created() {
    this.isLoading = true
    await this.$store.dispatch('auth/refreshToken', { id: this.$route.params.id })
    this.loadProjects()
  },
  methods: {
    searchUser() {},
