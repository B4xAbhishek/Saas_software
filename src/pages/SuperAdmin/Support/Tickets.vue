  ...
  <div class="d-flex flex-column flex-grow-1">
    ...
    <div v-if="stats" class="d-flex flex-wrap align-center mb-3">
      <div class="d-flex align-center">
        ...
        <strong class="ml-2">{{ stats.total }}</strong>
      </div>
    ...
    <CreateTicket v-if="ticketDialog" :ticket-dialog="ticketDialog" @close="ticketDialog = false" @refresh="refresh" />
    <EditTicket
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: 'Assigned', value: 'assigned_to.email' },
